...
scene::IAnimatedMesh* IrrAssimpImport::createMesh(io::IReadFile* file)
{
    ...
    m_assimpScene = importer.ReadFile(irrToAssimpPath(file->getFileName()).C_Str(), aiProcess_Triangulate | aiProcess_GenSmoothNormals | aiProcess_FlipUVs | aiProcess_ConvertToLeftHanded);
    if (!m_assimpScene)
    {
